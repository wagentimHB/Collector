...
public class Engelvoelkers extends AbstractSite
{
    ...
    public Engelvoelkers()
    {
        dbHandler = new ObjectDBImmoHandler("D:\\test\\ebay_gartengrundstueck.odb");
    }
    ...
    public void execute()
    {
        ...
        wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector(SELECT_ACCEPT)));
        WebElement we = webDriver.findElement(By.cssSelector(SELECT_ACCEPT));
        ...
        //we = webDriver.findElement(By.cssSelector(SELECT_CLOSE_LOGIN));
